const APP_KEY = 'personel_yasam_v5';
const LEGACY_APP_KEYS = ['personel_yasam_v4', 'personel_yasam_v3'];

const seed = {
  users: [
    { id: 1, name: 'Serhat Admin', phone: '05000000001', password: '123456', role: 'admin', roles: ['staff','admin'], title: 'Sistem Yöneticisi', approved: true, annualAllowance: 30, usedLeave: 8, planningScore: 70, planningScoreNote: 'Demo puanı' },
    { id: 2, name: 'Mehmet Müdür', phone: '05000000002', password: '123456', role: 'manager', roles: ['staff','manager'], title: 'Müdür', approved: true, annualAllowance: 30, usedLeave: 12, planningScore: 86, planningScoreNote: 'Demo puanı' },
    { id: 3, name: 'Ahmet Yılmaz', phone: '05000000003', password: '123456', role: 'staff', roles: ['staff'], title: 'Personel', approved: true, annualAllowance: 30, usedLeave: 6, planningScore: 78, planningScoreNote: 'Demo puanı' },
    { id: 4, name: 'Mustafa Kaya', phone: '05000000004', password: '123456', role: 'staff', roles: ['staff'], title: 'Personel', approved: true, annualAllowance: 30, usedLeave: 14, planningScore: 65, planningScoreNote: 'Demo puanı' },
    { id: 5, name: 'Ali Demir', phone: '05000000005', password: '123456', role: 'staff', roles: ['staff'], title: 'Personel', approved: false, annualAllowance: 30, usedLeave: 0, planningScore: 50, planningScoreNote: '' },
    { id: 6, name: 'Hasan Aşçı', phone: '05000000006', password: '123456', role: 'cook', roles: ['staff','cook'], title: 'Aşçı', approved: true, annualAllowance: 30, usedLeave: 4, planningScore: 55, planningScoreNote: 'Demo puanı' },
    { id: 7, name: 'Serhat İdari İşler', phone: '05000000007', password: '123456', role: 'administrative', roles: ['staff','administrative'], title: 'İdari İşler', approved: true, annualAllowance: 30, usedLeave: 5, planningScore: 75, planningScoreNote: 'Demo puanı' },
    { id: 8, name: 'Karakol Komutanı', phone: '05000000008', password: '123456', role: 'commander', roles: ['staff','commander'], title: 'Karakol Komutanı', approved: true, annualAllowance: 30, usedLeave: 3, planningScore: 90, planningScoreNote: 'Demo puanı' }
  ],
  mealSelections: {
    1: {
      '2026-08-03': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-04': { breakfast: 'yes', lunch: 'duty', dinner: 'yes' },
      '2026-08-05': { breakfast: 'no', lunch: 'yes', dinner: 'yes' },
      '2026-08-06': { breakfast: 'yes', lunch: 'yes', dinner: 'duty' },
      '2026-08-07': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-08': { breakfast: 'yes', lunch: 'no', dinner: 'no' },
      '2026-08-09': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' }
    },
    2: {
      '2026-08-03': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-04': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-05': { breakfast: 'yes', lunch: 'duty', dinner: 'duty' },
      '2026-08-06': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-07': { breakfast: 'no', lunch: 'no', dinner: 'no' },
      '2026-08-08': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-09': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' }
    },
    3: {
      '2026-08-03': { breakfast: 'yes', lunch: 'no', dinner: 'yes' },
      '2026-08-04': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-05': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-06': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-07': { breakfast: 'yes', lunch: 'duty', dinner: 'yes' },
      '2026-08-08': { breakfast: 'no', lunch: 'no', dinner: 'no' },
      '2026-08-09': { breakfast: 'no', lunch: 'no', dinner: 'no' }
    },
    4: {
      '2026-08-03': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-04': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-05': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-06': { breakfast: 'duty', lunch: 'duty', dinner: 'duty' },
      '2026-08-07': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-08': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-09': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' }
    },
    6: {
      '2026-08-03': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-04': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-05': { breakfast: 'yes', lunch: 'yes', dinner: 'no' },
      '2026-08-06': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-07': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' },
      '2026-08-08': { breakfast: 'yes', lunch: 'no', dinner: 'no' },
      '2026-08-09': { breakfast: 'yes', lunch: 'yes', dinner: 'yes' }
  ...
  debts: [
    { userId: 1, period: 'Ağustos 2026', amount: 1380, paid: 0 },
    { userId: 2, period: 'Ağustos 2026', amount: 1320, paid: 1320 },
  ...
  leaveRequests: [
    ...
    { id: 4, userId: 3, type: 'Yıllık İzin', start: '2026-05-04', end: '2026-05-10', days: 7, city: 'İzmir', note: '', status: 'approved' }
  ],
  leavePreferences: [
    { id: 1, userId: 2, year: 2027, firstStart: '2027-07-05', firstEnd: '2027-07-18', secondStart: '2027-08-02', secondEnd: '2027-08-15', note: 'Birinci tercih öncelikli', submittedAt: '2026-08-05', status: 'submitted' },
    { id: 2, userId: 3, year: 2027, firstStart: '2027-06-14', firstEnd: '2027-06-27', secondStart: '2027-09-06', secondEnd: '2027-09-19', note: '', submittedAt: '2026-08-05', status: 'submitted' },
    { id: 3, userId: 4, year: 2027, firstStart: '2027-07-12', firstEnd: '2027-07-25', secondStart: '2027-08-16', secondEnd: '2027-08-29', note: '', submittedAt: '2026-08-05', status: 'submitted' }
  ],
  leavePlanResults: [],
  laundry: [
  ...
  attendance: [
    { id: 1, userId: 3, status: 'duty', start: '2026-08-10', end: '2026-08-10', note: 'İlçe merkezinde görev', source: 'manual' },
    { id: 2, userId: 6, status: 'course', start: '2026-08-10', end: '2026-08-12', note: 'Hizmet içi eğitim', source: 'manual' }
  ],
  auditLogs: [],
  settings: {
...
function loadDB() {
  try {
    ...
    if (stored) return ensureV5Data(stored);
    for (const key of LEGACY_APP_KEYS) {
      const legacy = JSON.parse(localStorage.getItem(key));
      if (legacy) {
        const migrated = ensureV5Data(legacy);
...
function ensureV5Data(data) {
  ...
  data.users.forEach(u => { u.roles = Array.isArray(u.roles) && u.roles.length ? u.roles : (roleMap[u.role] || ['staff']); u.extraPermissions ||= []; });
  for (const id of [6,7,8]) {
    if (!data.users.some(u => u.id === id)) {
      const demo = structuredClone(seed.users.find(u => u.id === id));
      if (demo) data.users.push(demo);
    }
  }
  if (!data.mealSelections[6] && seed.mealSelections[6]) data.mealSelections[6] = structuredClone(seed.mealSelections[6]);
  return data;
}
...
function approvedUsers() { return db.users.filter(u => u.approved); }
...
function init() {
  ...
  document.getElementById('loginForm').addEventListener('submit', e => {
    ...
    if (!user.approved) return toast('Üyeliğiniz henüz onaylanmadı.');
    login(user);
  });
  document.getElementById('registerForm').addEventListener('submit', e => {
    ...
    db.users.push({
      ...
      password: document.getElementById('registerPassword').value, role: 'staff', roles: ['staff'], extraPermissions: [],
      title: document.getElementById('registerTitle').value.trim(), approved: false,
      annualAllowance: 30, usedLeave: 0, planningScore: 50, planningScoreNote: ''
    });
    saveDB();
    e.target.reset();
    toast('Başvurunuz alındı. Admin onayından sonra giriş yapabilirsiniz.');
  ...
  document.getElementById('notificationBtn').addEventListener('click', () => toast('Bildirim merkezi sonraki sürümde merkezi veritabanına bağlanacak.'));
...
function approveMember(id) { if (!isAdmin()) return; const u = getUser(id); if (u) { u.approved = true; saveDB(); renderMembers(); toast('Üyelik onaylandı.'); } }
function rejectMember(id) { if (!isAdmin()) return; db.users = db.users.filter(u => u.id !== id); saveDB(); renderMembers(); toast('Başvuru reddedildi.'); }
function newMemberModal() {
  ...
  showModal('Yeni Personel Ekle', `<form id="newMemberForm" class="form-grid">
    ...
    <label class="span-2">Geçici şifre<input name="password" value="123456" required></label>
  ...
  document.getElementById('newMemberForm').addEventListener('submit', e => {
    ...
    db.users.push({ id: Date.now(), name: f.get('name'), phone: normalizePhone(f.get('phone')), title: f.get('title'), role: f.get('role'), roles: f.get('role') === 'staff' ? ['staff'] : ['staff', f.get('role')], extraPermissions: [], password: f.get('password'), approved: true, annualAllowance: Number(f.get('annualAllowance')), usedLeave: 0, planningScore: Number(f.get('planningScore')), planningScoreNote: '' });
    saveDB(); closeModal(); renderMembers(); toast('Personel eklendi.');
  });
}
