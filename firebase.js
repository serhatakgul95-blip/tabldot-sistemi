...
const firebaseConfig = {
  apiKey: 'AIzaSyAUAdNig1Z0uM3JcAUW4JbEAHJg5JwnQD8',
...
async function loadState(updateSnapshot = true) {
  ...
  const [users, meals, expenses, payments, debts, leaves, prefs, plans, laundry, attendance, audits] = await Promise.all([
